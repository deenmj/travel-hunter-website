  ...
  return (
    <section className="relative w-full h-[70vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 w-full flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tight text-white mb-5 drop-shadow-2xl max-w-5xl leading-[1.1] animate-fade-in-up animation-delay-200">
        ...
        <p className="text-base sm:text-lg md:text-xl text-slate-100/90 mb-10 max-w-2xl mx-auto leading-relaxed drop-shadow-md font-medium animate-fade-in-up animation-delay-400">
